...
if (isset($_POST['delete_sid'])) {
    ...
    $delete_sql = "DELETE FROM invoice WHERE SID = $delete_sid";
    $result = mysqli_query($con, $delete_sql);
    if (!$result) {
        echo "Erreur lors de la suppression de la facture. Veuillez réessayer plus tard.";
    } else {
...
$sql = "SELECT * FROM invoice ORDER BY SID DESC";
...
<div class="container mt-4" id="couleur">
    ...
    <a href="indexFacture.php" class="btn btn-primary">YENI FACTURES</a>
    <div id="display"></div>
    <table class="table">
        <thead>
        <tr>
