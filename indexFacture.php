...
<html>
  ...
  <body>
    <div class='container pt-5'>
      <h1 class='text-center text-primary'>FACTURE COBAN PLAQUISTE</h1><hr>
      <?php
        if(isset($_POST["submit"])){
          ...
          if($con->query($sql)){
            ...
            $sql2="insert into invoice_products (SID,PNAME,PRICE,QTY,METRE,TOTAL) values ";
            $rows=[];
            ...
            $sql2.=implode(",",$rows);
            if($con->query($sql2)){
              echo "<div class='alert alert-success'>Facture ajouté. <a href='print.php?id={$sid}' target='_BLANK'>CLIQUEZ</a> ici pour voir la facture </div> ";
            }else{  
      ...
      <form method='post' action='indexFacture.php' autocomplete='off'>
        <div class='row'>
          <div class='col-md-4'>
            <h5 class='text-success'>Detail de la facture</h5>
        ...
        <div class='row'>
          <div class='col-md-12'>
            <h5 class='text-success'>Détail Facture</h5>
